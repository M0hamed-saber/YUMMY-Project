...
function Opennavbar (){
    ...
    $(".open-close-icon").removeClass("fa-align-justify");//same icon(-)
    $(".open-close-icon").addClass("fa-x");//same icon(x)

for (var i = 0; i < 5; i++) {
    $(".links li").eq(i).animate({top: 0}, (i + 5) * 100)
}
}
//function open Reverse function close
function closeSideNav (){
    let width = $(".side-nav-menu .navbar-tags").outerWidth()
...
showSearchInputs.addEventListener('click' ,    function(){
